...
public class LibraryTest extends IntegrationTestAbstract {
    ...
    @Test
    public void AddMedia_CheckThatIsInLibraryIsTrueWhenGettingMedia() {
        /* Init */
        var media = dummyDataCreator.generateMedia(true, MediaTypeEnum.MOVIE); // create media in database
        ...
        Assertions.assertThat(getMediaResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
        Assertions.assertThat(getMediaResponse.getBody()).isNotNull();
        Assertions.assertThat(getMediaResponse.getBody().getIsInLibrary()).isTrue();
        ...
        Assertions.assertThat(headings.getFirst().getIsInLibrary()).isTrue();
        ...
        Assertions.assertThat(recommendationsResponse.getBody().getContent().getFirst().getMedia().getIsInLibrary()).isTrue();
    }
