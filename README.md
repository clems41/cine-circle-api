...
Côté front, il faut utiliser le websocket mis en place sur l'url ``ws://localhost:5001/api/v1/notifications/websocket`` et en précisant le topic reçu précédemment ``/topic/XXX`` lors de la subscription.
